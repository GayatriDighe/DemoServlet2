...
protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	try {
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/teacher?useSSL=false", "root", "G@yatri123!");
		PreparedStatement ps = con.prepareStatement("insert into  applicants(first_name,last_name,gender,Email,password,Mobile_No,dob,Degree_passing_year,Specialization,semester,tenth_percentage,twelth_percentage,Graduation_percentage,Fresher_Exp) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
